        ...
        if(checkbox.checked){
            ...
            if(senha === confirmar_senha){
                const obj = {
                    ...
                    mostrarModal('As senhas sao diferentes', "imagens/Logos/MUTT-ERROR.png");
                }
            } else {
                mostrarModal('Por favor, aceite os termos', "imagens/Logos/MUTT-ERROR.png");
            }
        } else {
            mostrarModal('Preencha todos os campos', "imagens/Logos/MUTT-ERROR.png");
    }
}
